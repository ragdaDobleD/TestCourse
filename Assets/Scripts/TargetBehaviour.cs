...
public class TargetBehaviour : MonoBehaviour
{
    ...
    public float frecuency = 5.0f; //Velocidad de movimiento sinuosidal en el eje Y
    public float magnitude = 0.1f; //Amplitud del moovimiento
    ...
    IEnumerator MoveTarget()
    {
        ...
        //Estoy mirando a la derecha o a la izq
        ...
        while(currentTime < movementTime)
        {
            ...
            //s = +/-(1,0,0) * v* t
            pos += parent.transform.right * moveSpeed * Time.deltaTime;
            //s = +/-(0,1,0) * sen(w * t) * A
            pos += parent.transform.up * Mathf.Sin(frecuency * Time.time) * magnitude;
