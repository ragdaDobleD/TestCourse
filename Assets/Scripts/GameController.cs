...
{
    //Síngleton de la clase Game Controller
    ...
    void Start()
    {
        ...
        //Recupero la puntuación máxima de la preferencias del jugador
    ...
    {
        int idx = Random.Range(0, targets.Count); //Genera un nnúmero aleatorio entre 0 y targets.Count -1
